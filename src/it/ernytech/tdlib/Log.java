...
public class Log {
    ...
    private static final FatalErrorCallbackPtr defaultFatalErrorCallbackPtr = new FatalErrorCallbackPtr() {

		@Override
		public void onFatalError(String error_message) {
    ...
    public static void setFatalErrorCallback(FatalErrorCallbackPtr fatalErrorCallback) {
        Log.fatalErrorCallback = fatalErrorCallback == null ? defaultFatalErrorCallbackPtr : fatalErrorCallback;
    }
    ...
    private static void onFatalError(final String errorMessage) {
        ...
        new Thread(new Runnable() {
				...
				public void run() {
					...
					Log.fatalErrorCallback.onFatalError(errorMessage);
