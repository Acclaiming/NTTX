...
public class EasyClient<T extends EasyClient> {
    ...
    public EasyClient(AuthorizationHandler authorizationHandler) {
        ...
        this.handlers.put(0L,new TdCallback());
    }
    ...
    public Response execute(TdApi.Function function) {
        ...
        final AtomicReference<Response> responseAtomicReference = new AtomicReference<Response>();
        final AtomicBoolean executedAtomicBoolean = new AtomicBoolean(false);

		execute(function,new ReceiveCallback() {
    ...
    private void inizializeClient() {
		...
		TdCallback callback = new TdCallback(new ReceiveCallback() {
        ...
        this.clientActor = new ClientActor(callback);
    }
