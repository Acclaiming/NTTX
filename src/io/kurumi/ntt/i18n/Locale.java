...
public class Locale {
	...
	public String CA_HELP = "**群组/频道清理成员** : " + "\n\n" + 

	"清理已删除的账号 : /clean_da" + "\n" +

	"清理所有成员 : /clean_all" + "\n\n" +

	"注意 : **必须由管理员在群组中使用命令执行** 且需要 **限制成员** 权限";
	...
	public String DNS_TYPE_INVALID = "无效的 [DNS记录类型](https://zh.wikipedia.org/wiki/%E5%9F%9F%E5%90%8D%E4%BC%BA%E6%9C%8D%E5%99%A8%E8%A8%98%E9%8C%84%E9%A1%9E%E5%9E%8B%E5%88%97%E8%A1%A8) .";
	public String DNS_DOMAIN_INVALID = "无效的 [域名](https://zh.m.wikipedia.org/zh-cn/%E5%9F%9F%E5%90%8D) .";
	public String DNS_NOT_FOUND = "没有对应的DNS记录.";

	// USER

	public String GET_USER = "取得一个用户的**永久链接** :" + "\n\n" +
	
	"/get_user @用户名 / 文本引用 / 用户ID";
	...
	public static class ENG extends Locale {{
			...
			CA_HELP = "Clean up group members :" + "\n\n" +
				...
				"This command requires **Restrict Member** permission.";
			...
			GET_USER = "Get a permanent link of a user : " + "\n\n" + 
				...
				"/get_user @user_name / text mention / user id";
