...
public class FloatConf extends BaseConf<Float> {

    public FloatConf(UserBot bot,String name,String key) {
        super(bot,name,key);
    }
    ...
    public AbsResuest onMessage(Message msg, AtomicBoolean back) {
        ...
        try {
            ...
            return new SendMsg(msg, "不是一个有效的浮点数！ 用 /cancel 取消更改");
