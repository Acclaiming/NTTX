...
public class MaterialColor {
	...
	public MaterialColor(String[] colors,int colorPrimary,int colorPrimaryDark,int colorAccent) {
	...
	public static MaterialColor GREEN = new MaterialColor(new String[] {"#E8F5E9", "#C8E6C9", "#A5D6A7", "#81C784", "#66BB6A", "#4CAF50", "#43A047", "#388E3C", "#2E7D32", "#1B5E20", "#B9F6CA", "#69F0AE", "#00E676", "#00C853"} ,5,7,11);
	public static MaterialColor GREEN_LIGHT = new MaterialColor(new String[] {"#F1F8E9", "#DCEDC8", "#C5E1A5", "#AED581", "#9CCC65", "#8BC34A", "#7CB342", "#689F38", "#558B2F", "#33691E", "#CCFF90", "#B2FF59", "#76FF03", "#64DD17"} ,5,7,11);
	public static MaterialColor LIME = new MaterialColor(new String[] {"#F9FBE7", "#F0F4C3", "#E6EE9C", "#DCE775", "#D4E157", "#CDDC39", "#C0CA33", "#AFB42B", "#9E9D24", "#827717", "#F4FF81", "#EEFF41", "#C6FF00", "#AEEA00"} ,5,7,11);
	public static MaterialColor YELLOW = new MaterialColor(new String[] {"#FFFDE7", "#FFF9C4", "#FFF59D", "#FFF176", "#FFEE58", "#FFEB3B", "#FDD835", "#FBC02D", "#F9A825", "#F57F17", "#FFFF8D", "#FFFF00", "#FFEA00", "#FFD600"} ,5,7,11);
	...
	public static MaterialColor[] all = new MaterialColor[] {
		...
		RED,INDIGO,CYAN,PURPLE_DEEP,PINK,BLUE,BLUE_LIGHT,PURPLE,TEAL,GREEN,GREEN_LIGHT,LIME,YELLOW,AMBER,ORANGE,ORANGE_DEEP,BROWN,GREY,GREY_BLUE
