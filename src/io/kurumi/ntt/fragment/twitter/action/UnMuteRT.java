...
public class UnMuteRT extends Fragment {
	...
	public void onTwitterFunction(UserData user,Msg msg,String function,String[] params,TAuth account) {
        ...
        if (params.length > 0) {
            ...
            for (String target : params) {
                ...
                unMuteRT(user, msg, account, api, targetId);
            ...
            unMuteRT(user, msg, account, api, targetUser);
    ...
    private void unMuteRT(UserData user, Msg msg, TAuth account, Twitter api, long targetId) {
