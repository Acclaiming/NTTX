...
public class GroupAdmin extends Fragment {
		...
		public static boolean fastAdminCheck(Fragment fragment,long chatId,long userId) {
				
				return fastAdminCheck(fragment,GroupData.get(chatId),userId);
				
		}
		
		public static boolean fastAdminCheck(Fragment fragment,GroupData data,long userId) {
