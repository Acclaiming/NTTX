...
public final class WeChatClient {
     ...
     */
    private void handleAvatar(String base64Avatar) {
    ...
    public static abstract class WeChatListener {
         ...
         */
        public abstract void onQRCode(WeChatClient client, String qrCode);
         ...
         */
        public void onAvatar(WeChatClient client, String base64Avatar) {
        }
         ...
         * @param reason 错误原因
         */
        public void onFailure(WeChatClient client, String reason) {
            client.dump();
        }
         ...
         * 用户登录并初始化成功
         */
        public void onLogin(WeChatClient client) {
        }
         ...
         * 模拟网页微信客户端正常退出
         */
        public void onLogout(WeChatClient client) {
            client.dump();
        }
    }
