...
final class WeChatApi {
    ...
    static File folder = new File(Env.CACHE_DIR,"wechat_cache");
     ...
     * @return 接口调用结果
     */
    public RspStatusNotify webwxstatusnotify(String userName,int notifyCode) {
     ...
     * @return 联系人的详细信息
     */
	public  RspBatchGetContact webwxbatchgetcontact(List<Contact> contactList) {
     ...
     * @return 撤回结果
     */
    public RspRevokeMsg webwxrevokemsg(long clientMsgId,long serverMsgId,String userName) {
     ...
     * @return 获取到的图片文件
     */
	public  File webwxgetmsgimg(long msgId,String type) {
     ...
     * @return 获取到的语音文件
     */
	public  File webwxgetvoice(long msgId) {
     ...
     * @return 获取到的视频文件
     */
    public File webwxgetvideo(long msgId) {
     ...
     * @return 获取到的附件文件
     */
    public File webwxgetmedia(long msgId,String filename,String mediaId,String sender) {
     ...
     * @return 发送的结果
     */
	public  RspVerifyUser webwxverifyuser(int opCode,String userName,String verifyTicket,String verifyContent) {
     ...
     * @return 修改备注的结果
     */
	public  RspOplog webwxoplog(int cmdId,int op,String userName,String remarkName) {
     ...
     * @return 添加或移除的结果
     */
	public  RspUpdateChatroom webwxupdatechartroom(String chatroom,String fun,String name,List<String> memberList) {
     ...
     * @return 秒传结果，
     */
	public  RspCheckUpload webwxcheckupload(File file,String fromUserName,String toUserName) {
     ...
     */
	public  RspUploadMedia webwxuploadmedia(String fromUserName,String toUserName,File file,String aesKey,String signature) throws IOException {
