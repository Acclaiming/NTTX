...
import org.telegram.api.encrypted.message.*;
import org.telegram.api.message.*;
import org.telegram.api.notify.peer.*;
import org.telegram.api.peer.*;
import org.telegram.api.update.*;
import org.telegram.api.update.encrypted.*;
import org.telegram.api.updates.*;
import org.telegram.api.updates.difference.*;
...
public abstract class UpdatesHandlerBase implements IUpdatesHandler {
    ...
    public final void onTLAbsDifference(@NotNull TLAbsDifference absDifference) {
		...
		for (TLAbsEncryptedMessage message : absDifference.getNewEncryptedMessages()) {
	...
	for (TLAbsUpdate update : absDifference.getOtherUpdates()) {
    ...
    public final void onTLChannelDifferences(List<TLAbsUser> users, List<TLAbsMessage> messages, List<TLAbsUpdate> newUpdates, List<TLAbsChat> chats) {
		...
		for (TLAbsMessage msg : messages) {
			
			onTLAbsMessageCustom(msg);
