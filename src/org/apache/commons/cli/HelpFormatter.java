...
public class HelpFormatter
{
     ...
     */
    public void printHelp(PrintWriter writer,String cmdLineSyntax, Options options)
    {
        printHelp(writer,getWidth(), cmdLineSyntax, null, options, null, false);
    }
     ...
     * usage statement
     */
    public void printHelp(PrintWriter writer,String cmdLineSyntax, Options options, boolean autoUsage)
    {
        printHelp(writer,getWidth(), cmdLineSyntax, null, options, null, autoUsage);
    }
    ...
    {
        printHelp(writer,cmdLineSyntax, header, options, footer, false);
    }
     ...
     * usage statement
     */
    public void printHelp(PrintWriter writer,String cmdLineSyntax, String header, Options options, String footer, boolean autoUsage)
    {
        printHelp(writer,getWidth(), cmdLineSyntax, header, options, footer, autoUsage);
    }
     ...
     * @param footer the banner to display at the end of the help
     */
    public void printHelp(PrintWriter writer,int width, String cmdLineSyntax, String header, Options options, String footer)
    {
        printHelp(writer,width, cmdLineSyntax, header, options, footer, false);
    }
