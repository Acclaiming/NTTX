...
public abstract class ParsedPIRResponse extends WhoisResponse {
     ...
     *
     * @param name The name that was queried.
     */
     ...
     *
     * @param line    A line of response data.
     * @param contact A contact instance.
     * @param prefix  The contact line prefix.
     ...
     *
     * @param registrant A contact object.
     */
     ...
     * Date object.
     *
     * @param expirationDate A date string in the following format: dd-MMM-yyyy HH:mm:ss z.
     * @throws ParseException
     */
     ...
     * Date object.
     *
     * @param lastUpdated A date string in the following format: dd-MMM-yyyy HH:mm:ss z.
     * @throws ParseException
     */
     ...
     * Date object.
     *
     * @param createdOn A date string in the following format: dd-MMM-yyyy HH:mm:ss z.
     * @throws ParseException
     */
